...
| OS/Platform         | x86_64    | arm64
| macOS (10.15+)      | Supported | Preview (M1)
| Ubuntu (18.04+)     | Supported | Supported
| Debian (Stretch/9+) | Supported | Supported
| CentOS (7+)         | Supported | Supported
| RHEL (7+)           | Supported | Supported
| Other Linux         | Preview   | Preview
| Docker              | Supported | Preview
| Windows             | Preview   | Preview
| Kubernetes          | Preview   | Preview
